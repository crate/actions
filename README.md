...
The PAT must have READ access to all repos and stored in the
[REPO_CLABOT_READ_CONTENT_ACCESS org secret](https://github.com/crate/actions/settings/secrets/actions).
